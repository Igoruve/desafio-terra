      ...
      >
        <fieldset className="w-full px-8 py-4 border-5 border-[#3D9DD8] rounded-xl flex flex-col">
          ...
          <input
            ...
            className="appearance-none bg-white border-3 border-[var(--bg-color)] rounded-[50px] px-4 py-2 mb-4 w-full"
          />
          ...
          <textarea
            ...
            className="appearance-none bg-white border-3 border-[var(--bg-color)] rounded-[20px] px-4 py-2 mb-4 w-full"
          ></textarea>
          <p className="text-right text-sm text-gray-400 mb-3">
          ...
          <div className="flex flex-row relative w-full items-center justify-between">
            <select
              ...
              required
              className="appearance-none pr-10 bg-white border-3 border-[var(--bg-color)] rounded-[50px] px-4 py-2 mb-4 cursor-pointer w-full"
            >
        ...
        <fieldset className="w-full p-4 border-5 border-[#EBA911] rounded-xl flex flex-col justify-start items-start">
          ...
          <textarea
            ...
            className="appearance-none bg-white border-3 border-[var(--bg-color)] rounded-[20px] px-4 py-2 mb-4 w-full cursor-text h-24"
          ></textarea>
